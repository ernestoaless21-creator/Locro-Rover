...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-herb': style == 'success', 'bg-ember': style == 'danger' }">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-green-700': style == 'success', 'bg-ember-strong': style == 'danger' }">
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="{ 'hover:bg-green-700 focus:bg-green-700': style == 'success', 'hover:bg-ember-strong focus:bg-ember-strong': style == 'danger' }"
                            aria-label="Dismiss"
